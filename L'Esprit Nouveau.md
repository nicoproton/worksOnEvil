...
***L'Esprit Nouveau*** was the Purist and modernist review founded by Amedee Ozenfant, Le Corbusier, and Paul Dermee, published from 1920 to 1925. It belongs in this graph because it is one of the key forums where modern art, architecture, urbanism, design, machine culture, and social reform were treated as parts of the same new spirit.

The journal is useful as a network node rather than a single treatise. It shows how ideas travel across domains before they harden into buildings or planning doctrines.
...
*L'Esprit Nouveau* belongs because it gives the graph a concrete node for the cross-domain circulation of modernist ideas. It shows how art, architecture, design, standardization, and urban reform could be imagined as one cultural project before being implemented in buildings and plans.
