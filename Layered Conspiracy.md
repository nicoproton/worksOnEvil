---
aliases: [Layered Conspiracies, Initiatory Conspiracy]
tags: [Conspiracy, NarrativeStructure, Concept]
---

# Layered Conspiracy

A layered conspiracy is a hidden structure in which different participants understand different versions of the project. Outer members may believe in reform, progress, loyalty, or ordinary self-interest, while an inner circle pursues a more destructive or secret aim.

The motif is useful because it explains complicity without requiring every participant to be fully malicious. It also creates narrative revelation: the deeper plot is uncovered by moving from public justification to private doctrine to hidden command.
