...
***Bauhaus Manifesto and Program*** is Walter Gropius's 1919 founding text for the State Bauhaus in Weimar. It calls for a new union of architecture, sculpture, painting, craft, and design under the horizon of building. Its famous cover image, Lyonel Feininger's cathedral woodcut, matters because the early Bauhaus was not yet merely the flat, functional, industrial style later associated with the name. It still imagined modern art as a spiritually charged communal work.

The manifesto belongs in the graph because it joins three currents that often separate elsewhere: the recovery of craft, the total artwork, and the modern reorganization of design education for a new society. It is one of the central cases of [[Art Into Life]], because art, craft, school, object, building, and daily environment begin to be treated as one formative project.

The Bauhaus changed over time. The early Weimar Bauhaus still carried Expressionist, spiritual, craft, and guild language. The later Dessau Bauhaus moved more openly toward industry, standardization, typography, housing, and reproducible design.
...
The Bauhaus did not only produce objects. It formed makers. Its curriculum, workshops, preliminary course, masters, and material exercises trained students to see form, color, material, function, and construction in a new way.

This makes the manifesto a useful case of [[Administered Human Formation]], though in a milder and educational sense. The point is not dystopian conditioning. The point is that modern design begins to require a new kind of person: the artist-craftsman-designer trained to work across media and eventually to serve modern life.
...
The Bauhaus sits awkwardly between [[Concerning the Spiritual in Art]] and [[High-Modernist Planning]]. Kandinsky's spiritual abstraction belongs to the early Bauhaus world of invisible form, inward necessity, and non-materialist modern art. The later planning branch belongs to the world where form becomes function, system, housing, circulation, and rational organization.

That tension is exactly why the manifesto is useful. It shows modernism before it hardens into one stereotype. Modernist rupture can be spiritual, craft-centered, revolutionary, pedagogical, industrial, rationalizing, or all of these at once.

## Why It Belongs Here

*Bauhaus Manifesto and Program* belongs in the graph because it shows how art education becomes a project for remaking the built and designed world. It does not simply reject tradition in favor of machinery, nor does it simply restore craft. It tries to gather craft, art, architecture, pedagogy, spirituality, and modern production into a new formative institution. That makes it one of the key source-texts for understanding how modern design becomes a social force.
